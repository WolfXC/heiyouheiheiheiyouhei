...
<div id="div1">
	...
	<form name="" action="" method="post">
    	<table id="table1">
        	<tr>
            	<td width="30%">会员编号：</td>
                <td width="70%"><input name="" type="text" /></td>
            </tr>
        	<tr>
            	<td>&nbsp;</td>
                <td><input name="" type="button" value="确定" onclick="window.location='reader_update_result1.html';" /><input name="" type="reset" value="重置" /></td>
            </tr>
        </table>
    </form>
</div>
