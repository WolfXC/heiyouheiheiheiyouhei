package com.hanhf.library.borrow.dao;
...
import com.hanhf.library.borrow.bean.Borrow;
import com.hanhf.library.borrow.bean.BorrowResult;

@Repository
public class BorrowDaoImpl extends HibernateDaoSupport implements BorrowDao {
	private String hql = "select new com.hanhf.library.borrow.bean.BorrowResult"
			+ "(bk.bookId, bk.bookNo, bk.bookName, bk.type.id, bk.type.name, bk.price,"
			+ "r.id, r.no, r.name, br.borrowDate, br.returnDate, br.oper)"
			+ " from Borrow br, Book bk, Reader r"
			+ " where br.bookNo=bk.bookNo and br.readerNo=r.no"
