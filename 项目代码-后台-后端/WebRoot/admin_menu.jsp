...
<ul class="level1">
    ...
    <li>
    	图书类别管理
        <ul class="level2">
        	<li><a href="type_add.jsp" target="main">添加图书类别</a></li>
            <li><a href="totype_del.do" target="main">删除图书类别</a></li>
        </ul>
    </li>
    <li>
    	会员管理
        <ul class="level2">
        	<li><a href="reader_add.jsp" target="main">添加会员</a></li>
        	<li><a href="reader_update.jsp" target="main">修改会员</a></li>
            <li><a href="reader_del.jsp" target="main">删除会员</a></li>
        </ul>
    </li>
    <li>
    	管理员维护
        <ul class="level2">
        	<li><a href="user_add.jsp" target="main">添加管理员</a></li>
        	<li><a href="user_update.jsp" target="main">修改管理员密码</a></li>
            <li><a href="toDeleteUser.do" target="main">删除管理员</a></li>
        </ul>
    </li>
</ul>
</body>
