...
<div id="div1">
	<h3>修改图书</h3>
	<form name="" action="update.do" method="post">
	<input name="book.bookId" type="hidden" value="${book.bookId}" />
    	<table id="table1">
        	<tr>
            	<td width="15%">书籍编号：</td>
                <td width="35%"><input name="book.bookNo" type="text" value="${book.bookNo}" /></td>
            	<td width="15%">书籍名称：</td>
                <td width="35%"><input name="book.bookName" type="text" value="${book.bookName}" /></td>
            </tr>
        	<tr>
            	<td>类别：</td>
                <td>
                	<select name="book.type.id">
                        ...
                        <option value="${type.id}"<c:if test="${type.id==book.type.id}">
                        selected="selected"</c:if>>${type.name}</option>
                        </c:forEach>
                    </select>
                </td>
            	<td>作者：</td>
